			...
			>
				<div>
					...
					<p className='description'>
						Kirk Koster built the DnDMe app as an Ad Supported app. This SERVICE
						is provided by Kirk Koster at no cost and is intended for use as is.
						...
						our Terms and Conditions, which are accessible at DnDMe unless
						otherwise defined in this Privacy Policy.
					</p>

					<Header title='Information Collection and Use' />
					<p className='description'>
						...
						<p>
							<Link href='https://support.google.com/admob/answer/6128543?hl=en'>
								* [AdMob]
							</Link>
						</p>
						<p>
					...
					<p className='description'>
						...
						<p>To assist us in analyzing how our Service is used.</p>I want to
						inform users of this Service that these third parties have access to
						their Personal Information. The reason is to perform the tasks
					...
					<Header title='Links to Other Sites' />
					<p className='description'>
					...
					<Header title='Changes to This Privacy Policy' />
					<p className='description'>
						I may update our Privacy Policy from time to time. Thus, you are
						advised to review this page periodically for any changes. I will
						notify you of any changes by posting the new Privacy Policy on this
						page. This policy is effective as of 2021-11-28
					</p>
					<Header title='Contact Us' />
					<p className='description'>
						If you have any questions or suggestions about my Privacy Policy, do
						not hesitate to contact me at kirkkoster@gmail.com.
						<p>
							This privacy policy page was created at{' '}
							<Link href='https://www.privacypolicytemplate.net/'>
